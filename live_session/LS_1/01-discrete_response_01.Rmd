...
- [Digital Campus](https://2uciam.onelogin.com/)
...
2. Before the next live session: 
    1. Please fill out the survey in the slack channel, so we van create teams for Lab-1 ASAP. 
    2. Complete the homework that builds on this unit
    3. Complete all videos and reading for unit 2
    4. Fill out the group assignment questionnaire
    5. Try to look at the live session two plan, install the required packages, and check the case study section, especially the introduction, data cription and descriptive Statistics.
